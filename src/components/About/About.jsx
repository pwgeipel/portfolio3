        ...
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full px-4 grid grid-cols-2 gap-8'>
                <div classname="sm:text-right">
                    <p className='text-3xl font-bold inline border-b-4 border-linkColor text-eggplant' data-aos="fade-right"
                    data-aos-duration="750">About</p>
                </div>
            </div>
            <div className='max-w-[1000px] w-full px-4 grid sm:grid-cols-2 gap-8'>
                <div className='text-3xl pt-8'>
                    <p data-aos="fade-right" 
                    data-aos-delay="1000" data-aos-duration="750">
                        Hello, I'm Peter.  Pleased to meet you!</p>
                </div>
